...
/**
 * The Select Component for creating a customizable dropdown field.
 *
 * **Structure**:
 * ```tsx
 * <Root>
 ...
 */
declare const Select: <T extends object | string | number>({ id, name, required, options, placeholder, value, defaultValue, size, color, state, theme, disabled, onChange, rootStyle, triggerStyle, triggerTextStyle, triggerIconStyle, menuWrapperStyle, menuStyle, optionStyle, optionTextStyle, optionIconStyle, scrollNudgerStyle, scrollIconStyle, }: SelectProps<T>) => import("react/jsx-runtime").JSX.Element;
